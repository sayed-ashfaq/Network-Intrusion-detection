...
<head>
  <meta charset="utf-8" />
  <title>PhishGuard AI — Phishing Website Detection</title>
...
<div class="container">
  ...
  <h2>🛡️ PhishGuard AI — Real-time Phishing Website Detection</h2>
  ...
  <div class="card">
    <form method="post" action="/predict">
      ...
      <!-- PRESETS -->
      <div class="row">
        <button type="button" class="btn legit" onclick="fillLegit()">✔ Likely Legit</button>
        <button type="button" class="btn phish" onclick="fillPhish()">⚠ Likely Phishing</button>
        <button type="button" class="btn reset" onclick="resetAll()">↺ Reset</button>
      </div>

      <!-- URL STRUCTURE -->
      <fieldset>
        <legend class="url">🔐 URL Structure</legend>
        <div class="grid">
      ...
      <!-- SECURITY -->
      <fieldset>
        <legend class="security">🔒 Security & SSL</legend>
        <div class="grid">
      ...
      <!-- DOMAIN TRUST -->
      <fieldset>
        <legend class="trust">🌐 Domain Trust & Reputation</legend>
        <div class="grid">
      ...
      <!-- BEHAVIOR -->
      <fieldset>
        <legend class="behavior">🚨 Suspicious Page Behavior</legend>
        <div class="grid">
